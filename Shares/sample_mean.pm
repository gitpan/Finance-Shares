...
Finance::Shares::sample_mean - average of all values on a line

=head1 SYNOPSIS

Two examples of how to specify a sample_mean line, one showing the minimum
...
This module calculates the mean value found in the source line and displays
a line at that level.  It also returns a value that can be used by
a code fragment.

    my $mean = value( $source_line );
...
Required.  Must be C<sample_mean>.
