package Finance::Shares::maximum;
our $VERSION = 1.03;
use strict;
use warnings;
...
Finance::Shares::maximum - Highest value of a given line

=head1 SYNOPSIS

Two examples of how to specify a maximum line, one showing the minimum
...
This module calculates the maximum value found in the source line and displays
a line at that value.  It also returns a value C<maximum> that can be used by
a code fragment.

    my $maximum = value( $source_line );
