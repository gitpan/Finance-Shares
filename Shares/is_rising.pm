package Finance::Shares::is_rising;
our $VERSION = 1.00;
use strict;
use warnings;
...
Two examples of how to specify a rising line, one showing the minimum
...
rising line, it will NOT relate to the Y axis.  '0' will probably be around
the middle (vertically) of the rising line, while for the Y axis, '0' may well
...
field with the value C<is_rising>.  
